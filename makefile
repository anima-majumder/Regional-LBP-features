...
srcs =
srcs +=./source/LBP.cpp 
srcs +=./source/constants.cpp
srcs +=./source/face_features.cpp
srcs +=./source/GABOR.cpp
srcs +=main_lbp.cpp
...
.SUFFIXES:-lcv -lcxcore -lhighgui -lcvaux
.SUFFIXES: .cpp .o 
...
clean:
	$(RM) *.dat *.out *.jpeg  *.jpg *.txt $(objs) $(deps) $(exe) 
